(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.auth0 = {}));
  ...
  async function oauthToken(_a, worker) {
    var {
      ...
      options = __rest(_a, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
  ...
  const patchOpenUrlWithOnRedirect = options => {
    const {
      ...
      originalOptions = __rest(options, ["openUrl", "onRedirect"]);
  ...
  class Auth0Client {
    ...
    async loginWithRedirect(options = {}) {
      var _a;
      const _b = patchOpenUrlWithOnRedirect(options),
        {
          openUrl: openUrl,
          fragment: fragment,
          appState: appState
        } = _b,
        urlOptions = __rest(_b, ["openUrl", "fragment", "appState"]);
      ...
      const _c = await this._prepareAuthorizeUrl(urlOptions.authorizationParams || {}),
        {
          url: url
        } = _c,
        transaction = __rest(_c, ["url"]);
    ...
    async handleRedirectCallback(url = window.location.href) {
      ...
      const {
        ...
        error: error,
        error_description: error_description
      } = parseQueryResult(queryStringFragments.join(""));
    ...
    async _getTokenSilently(options) {
      const {
        ...
        getTokenOptions = __rest(options, ["cacheMode"]);
      if (cacheMode !== "off") {
    ...
    _buildLogoutUrl(options) {
      ...
      const _a = options.logoutParams || {},
        {
          federated: federated
        } = _a,
        logoutOptions = __rest(_a, ["federated"]);
    ...
    async logout(options = {}) {
      const _a = patchOpenUrlWithOnRedirect(options),
        {
          openUrl: openUrl
        } = _a,
        logoutOptions = __rest(_a, ["openUrl"]);
    ...
    async _getTokenFromIFrame(options) {
      ...
      const {
        ...
        scope: scope,
        audience: audience
      } = await this._prepareAuthorizeUrl(params, {
        response_mode: "web_message"
      }, window.location.origin);
      try {
    ...
    async _saveEntryInCache(entry) {
      const {
        ...
        entryWithoutIdToken = __rest(entry, ["id_token", "decodedToken"]);
