!function (e, t) {
  ...
  var s = n(function (e, t) {
      var o = i && i.__awaiter || function (e, t, i, o) {
        ...
        n = i && i.__generator || function (e, t) {
          var i,
            o,
            n,
            a,
        ...
        return e.prototype.acquireLock = function (t, i) {
          return void 0 === i && (i = 5e3), o(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  o = Date.now() + c(4), a = Date.now() + i, d = s + "-" + t, u = window.localStorage, n.label = 1;
                case 1:
                  return Date.now() < a ? [4, r(30)] : [3, 8];
                case 2:
                  return n.sent(), null !== u.getItem(d) ? [3, 5] : (l = this.id + "-" + t + "-" + o, [4, r(Math.floor(25 * Math.random()))]);
                case 3:
                  return n.sent(), u.setItem(d, JSON.stringify({
                    id: this.id,
                    iat: o,
                    timeoutKey: l,
                ...
                case 4:
                  return n.sent(), null !== (h = u.getItem(d)) && (h = JSON.parse(h)).id === this.id && h.iat === o ? (this.acquiredIatSet.add(o), this.refreshLockWhileAcquired(d, o), [2, !0]) : [3, 7];
                case 5:
                ...
                return o(i, void 0, void 0, function () {
                  ...
                  return n(this, function (n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return n.sent(), this.acquiredIatSet.has(t) ? (i = window.localStorage, null === (o = i.getItem(e)) ? (a.default().unlock(t), [2]) : ((o = JSON.parse(o)).timeRefreshed = Date.now(), i.setItem(e, JSON.stringify(o)), a.default().unlock(t), this.refreshLockWhileAcquired(e, t), [2])) : (a.default().unlock(t), [2]);
                    }
                  });
                });
              }, 1e3), [2];
          ...
          return o(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  return i = window.localStorage, o = s + "-" + t, null === (r = i.getItem(o)) ? [2] : (r = JSON.parse(r)).id !== this.id ? [3, 2] : [4, a.default().lock(r.iat)];
                case 1:
                  n.sent(), this.acquiredIatSet.delete(r.iat), i.removeItem(o), a.default().unlock(r.iat), e.notifyWaiters(), n.label = 2;
                case 2:
                  return [2];
              }
            });
  ...
  class h extends Error {
    constructor(e, t) {
      super(t), this.error = e, this.error_description = t, Object.setPrototypeOf(this, h.prototype);
    }
    static fromPayload({
      error: e,
      error_description: t
  ...
  class p extends h {
    constructor(e, t, i, o = null) {
      super(e, t), this.state = i, this.appState = o, Object.setPrototypeOf(this, p.prototype);
    }
  }
  class m extends h {
    constructor() {
  ...
  class f extends m {
    constructor(e) {
      super(), this.popup = e, Object.setPrototypeOf(this, f.prototype);
    }
  }
  class w extends h {
    constructor(e) {
  ...
  class g extends h {
    constructor(e, t, i) {
      super(e, t), this.mfa_token = i, Object.setPrototypeOf(this, g.prototype);
    }
  }
  class y extends h {
    constructor(e, t) {
      super("missing_refresh_token", `Missing Refresh Token (audience: '${k(e, ["default"])}', scope: '${k(t)}')`), this.audience = e, this.scope = t, Object.setPrototypeOf(this, y.prototype);
    }
  }
  function k(e, t = []) {
    return e && !t.includes(e) ? e : "";
  }
  const b = () => window.crypto,
    v = () => {
      const e = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_~.";
      let t = "";
      return Array.from(b().getRandomValues(new Uint8Array(43))).forEach(i => t += e[i % e.length]), t;
    },
    _ = e => btoa(e),
    I = e => {
      var {
    ...
    S = e => (e => decodeURIComponent(atob(e).split("").map(e => "%" + ("00" + e.charCodeAt(0).toString(16)).slice(-2)).join("")))(e.replace(/_/g, "/").replace(/-/g, "+")),
    T = async (e, t) => {
    ...
    O = async (e, t, i) => {
      ...
      let n;
      return t.signal = o.signal, Promise.race([T(e, t), new Promise((e, t) => {
        n = setTimeout(() => {
    ...
    j = async (e, t, i, o, n, a, s = 1e4) => n ? C(e, t, i, o, s, n, a) : O(e, o, s);
  async function x(e, i) {
    var {
      ...
      d = t(e, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
    const l = c ? I(d) : JSON.stringify(d);
    return await async function (e, i, o, n, a, s, r) {
      let c,
        d = null;
      for (let t = 0; t < 3; t++) try {
        c = await j(e, o, n, a, s, r, i), d = null;
        break;
      } catch (e) {
        d = e;
      }
      ...
      const u = c.json,
        ...
        m = t(u, ["error", "error_description"]),
        {
          ok: f
        } = c;
      if (!f) {
        const t = p || `HTTP error. Unable to fetch ${e}`;
        if ("mfa_required" === l) throw new g(l, t, m.mfa_token);
        throw new h(l || "request_error", t);
      }
      return m;
      ...
      headers: {
        ...
        "Auth0-Client": btoa(JSON.stringify(r || u))
      }
    }, i, c);
  }
  const z = (...e) => {
  ...
  class K {
    ...
    allKeys() {
      return Object.keys(window.localStorage).filter(e => e.startsWith(P));
    }
  }
  class L {
    constructor() {
  ...
  class U {
    constructor(e, t, i) {
      this.cache = e, this.keyManifest = t, this.nowProvider = i || l;
    }
    ...
    matchExistingCacheKey(e, t) {
      return t.filter(t => {
        ...
        return o.prefix === P && o.clientId === e.clientId && o.audience === e.audience && s;
      })[0];
    }
  }
  class N {
  ...
  const R = e => "number" == typeof e,
    ...
    X = e => {
      ...
      const t = (e => {
        ...
        const a = JSON.parse(S(o)),
          s = {
            __raw: e
          },
          r = {};
        return Object.keys(a).forEach(e => {
          s[e] = a[e], W.includes(e) || (r[e] = a[e]);
        }), {
          encoded: {
            header: i,
            payload: o,
      ...
      if (e.max_age && !R(t.claims.auth_time)) throw new Error("Authentication Time (auth_time) claim must be a number present in the ID token when Max Age (max_age) is specified");
      if (null == t.claims.exp || !R(t.claims.exp)) throw new Error("Expiration Time (exp) claim must be a number present in the ID token");
      if (!R(t.claims.iat)) throw new Error("Issued At (iat) claim must be a number present in the ID token");
      const i = e.leeway || 60,
      ...
      if (null != t.claims.nbf && R(t.claims.nbf)) {
        const e = new Date(0);
      ...
      if (null != t.claims.auth_time && R(t.claims.auth_time)) {
        const n = new Date(0);
  ...
  var V = n(function (e, t) {
    ...
    t.__esModule = !0, t.encode = a, t.parse = s, t.getAll = r, t.get = function (e) {
      return r()[e];
  ...
  const H = {
      ...
      remove(e, t) {
        let i = {};
        (null == t ? void 0 : t.cookieDomain) && (i.domain = t.cookieDomain), F(e, i);
      }
    },
    M = {
      get(e) {
        const t = H.get(e);
        return t || H.get(`_legacy_${e}`);
      },
      save(e, t, i) {
        let o = {};
        "https:" === window.location.protocol && (o = {
      ...
      remove(e, t) {
        let i = {};
        (null == t ? void 0 : t.cookieDomain) && (i.domain = t.cookieDomain), F(e, i), H.remove(e, t), H.remove(`_legacy_${e}`, t);
      }
    },
    G = {
      get(e) {
  ...
  const ie = "auth0.lock.getTokenSilently",
    oe = "auth0.is.authenticated",
    ne = {
      memory: () => new L().enclosedCache,
      localstorage: () => new K()
    },
    ae = e => ne[e],
    se = e => {
  ...
  class ce {
    constructor(e) {
      let t, i;
      if (this.userCache = new L().enclosedCache, this.defaultOptions = {
        authorizationParams: {
        ...
        await re.releaseLock(ie), window.removeEventListener("pagehide", this._releaseLockOnPageHide);
        ...
        if (!b()) throw new Error("For security reasons, `window.crypto` is required to run `auth0-spa-js`.");
        if (void 0 === b().subtle) throw new Error("\n      auth0-spa-js must run on a secure origin. See https://github.com/auth0/auth0-spa-js/blob/master/FAQ.md#why-do-i-get-auth0-spa-js-must-run-on-a-secure-origin for more information.\n    ");
        ...
        if (t = e.cacheLocation || d, !ae(t)) throw new Error(`Invalid cache location "${t}"`);
        i = ae(t)();
      }
      this.httpTimeoutMs = e.httpTimeoutInSeconds ? 1e3 * e.httpTimeoutInSeconds : 1e4, this.cookieStorage = !1 === e.legacySameSiteCookie ? H : M, this.orgHintCookieName = `auth0.${this.options.clientId}.organization_hint`, this.isAuthenticatedCookieName = (e => `auth0.${e}.is.authenticated`)(this.options.clientId), this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1;
      const o = e.useCookiesForTransactions ? this.cookieStorage : G;
      var n;
    ...
    _url(e) {
      const t = encodeURIComponent(btoa(JSON.stringify(this.options.auth0Client || u)));
      return `${this.domainUrl}${e}&auth0Client=${t}`;
    }
    _authorizeUrl(e) {
      return this._url(`/authorize?${I(e)}`);
    }
    ...
    async loginWithPopup(e, t) {
      ...
      const n = await (e => new Promise((t, i) => {
        let o;
        const n = setInterval(() => {
            e.popup && e.popup.closed && (clearInterval(n), clearTimeout(a), window.removeEventListener("message", o, !1), i(new w(e.popup)));
          }, 1e3),
          a = setTimeout(() => {
            clearInterval(n), i(new f(e.popup)), window.removeEventListener("message", o, !1);
          }, 1e3 * (e.timeoutInSeconds || 60));
        o = function (s) {
          if (s.data && "authorization_response" === s.data.type) {
            if (clearTimeout(a), clearInterval(n), window.removeEventListener("message", o, !1), e.popup.close(), s.data.response.error) return i(h.fromPayload(s.data.response));
            t(s.data.response);
          }
    ...
    async loginWithRedirect(e = {}) {
      ...
      const o = se(e),
        ...
        r = t(o, ["openUrl", "fragment", "appState"]),
    ...
    async handleRedirectCallback(e = window.location.href) {
      ...
      if (this.transactionManager.remove(), n) throw new p(n, a || n, i, s.appState);
    ...
    async checkSession(e) {
      if (!this.cookieStorage.get(this.isAuthenticatedCookieName)) {
        if (!this.cookieStorage.get(oe)) return;
        this.cookieStorage.save(this.isAuthenticatedCookieName, !0, {
          daysUntilExpire: this.sessionCheckExpiryDays,
          cookieDomain: this.options.cookieDomain
        }), this.cookieStorage.remove(oe);
      }
      try {
    ...
    async getTokenSilently(e = {}) {
      ...
      const i = Object.assign(Object.assign({
          ...
          authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e.authorizationParams), {
            scope: z(this.scope, null === (t = e.authorizationParams) || void 0 === t ? void 0 : t.scope)
          })
        }),
        o = await ((e, t) => {
          let i = ee[t];
    ...
    async _getTokenSilently(e) {
      ...
      if ("cache-only" !== i) {
        if (!(await (async (e, t = 3) => {
          ...
          return !1;
        })(() => re.acquireLock(ie, 5e3), 10))) throw new m();
        try {
    ...
    async getTokenWithPopup(e = {}, t = {}) {
      ...
      const o = Object.assign(Object.assign({}, e), {
        authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e.authorizationParams), {
          scope: z(this.scope, null === (i = e.authorizationParams) || void 0 === i ? void 0 : i.scope)
        })
      });
      t = Object.assign(Object.assign({}, c), t), await this.loginWithPopup(o, t);
      return (await this.cacheManager.get(new E({
        scope: o.authorizationParams.scope,
        audience: o.authorizationParams.audience || "default",
        clientId: this.options.clientId
      }))).access_token;
    ...
    async _getTokenFromIFrame(e) {
      ...
      try {
        if (window.crossOriginIsolated) throw new h("login_required", "The application is running in a Cross-Origin Isolated context, silently retrieving a token without refresh token is not possible.");
        const t = e.timeoutInSeconds || this.options.authorizeTimeoutInSeconds,
          i = await ((e, t, i = 60) => new Promise((o, n) => {
            ...
            r = function (e) {
              ...
              const i = e.source;
              i && i.close(), e.data.response.error ? n(h.fromPayload(e.data.response)) : o(e.data.response), clearTimeout(c), window.removeEventListener("message", r, !1), setTimeout(s, 2e3);
        ...
        const u = await this._requestToken(Object.assign(Object.assign({}, e.authorizationParams), {
          code_verifier: s,
          code: i.code,
          grant_type: "authorization_code",
          redirect_uri: r,
    ...
    async _getTokenUsingRefreshToken(e) {
      const t = await this.cacheManager.get(new E({
      ...
      if (!(t && t.refresh_token || this.worker)) {
        ...
        throw new y(e.authorizationParams.audience || "default", e.authorizationParams.scope);
      }
    ...
    async _saveEntryInCache(e) {
      const {
        ...
        n = t(e, ["id_token", "decodedToken"]);
      this.userCache.set(Z, {
        id_token: i,
        decodedToken: o
      }), await this.cacheManager.setIdToken(this.options.clientId, e.id_token, e.decodedToken), await this.cacheManager.set(n);
    }
    async _getIdTokenFromCache() {
      const e = this.options.authorizationParams.audience || "default",
        t = await this.cacheManager.getIdToken(new E({
          clientId: this.options.clientId,
          audience: e,
          scope: this.scope
        })),
        i = this.userCache.get(Z);
      return t && t.id_token === (null == i ? void 0 : i.id_token) ? i : (this.userCache.set(Z, t), t);
    }
    async _getEntryFromCache({
      ...
      const o = await this.cacheManager.get(new E({
        scope: e,
        audience: t,
        clientId: i
      }), 60);
  ...
  e.Auth0Client = ce, e.AuthenticationError = p, e.CacheKey = E, e.GenericError = h, e.InMemoryCache = L, e.LocalStorageCache = K, e.MfaRequiredError = g, e.MissingRefreshTokenError = y, e.PopupCancelledError = w, e.PopupTimeoutError = f, e.TimeoutError = m, e.User = class {}, e.createAuth0Client = async function (e) {
    const t = new ce(e);
